        ...
        while True:
            ...
            if not ret:
                ...
                image, results = self.pose.detect_pose(
                    image, self.pose.pose_video, draw=True
                )
                ...
                if results.pose_landmarks:
                    ...
                    # ------------------------------------------------------------------------------------------------------------------
                    # Check if the left and right hands are up.
                    if self.pose.check_hands_up(image, results)[1] == "Hands Up":
                    ...
                    # Otherwise if the left and right hands are not up.
                    else:
                        # Update the counter value to zero.
                        self.counter = 0
                ...
                cv2.imshow("Chrome Dino with Pose Detection", image)
